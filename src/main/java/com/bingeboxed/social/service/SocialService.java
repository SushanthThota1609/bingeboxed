...
public interface SocialService {
    ...
    List<UserSearchResult> searchUsers(String query, Long currentUserId);

    PublicUserProfileResponse getPublicProfile(Long targetUserId, Long currentUserId);
    ...
    List<PublicWatchlistEntryResponse> getPublicWatchlist(Long targetUserId);
